...
Each row shows the original image, editing mask, reference image, and final result. Green overlays indicate the selected editing regions.

| Original | Mask | Reference | Result |
| :---: | :---: | :---: | :---: |
| <img src="assets/examples/cat/original.png" alt="cat original" width="220"> | <img src="assets/examples/cat/mask.png" alt="cat mask" width="220"> | <img src="assets/examples/cat/reference.png" alt="cat reference" width="220"> | <img src="assets/examples/cat/result.png" alt="cat result" width="220"> |
| <img src="assets/examples/coffee/original.png" alt="coffee original" width="220"> | <img src="assets/examples/coffee/mask.png" alt="coffee mask" width="220"> | <img src="assets/examples/coffee/reference.png" alt="coffee reference" width="220"> | <img src="assets/examples/coffee/result.png" alt="coffee result" width="220"> |
| <img src="assets/examples/dress/original.png" alt="dress original" width="220"> | <img src="assets/examples/dress/mask.png" alt="dress mask" width="220"> | <img src="assets/examples/dress/reference.png" alt="dress reference" width="220"> | <img src="assets/examples/dress/result.png" alt="dress result" width="220"> |
| <img src="assets/examples/bouquet/original.png" alt="bouquet original" width="220"> | <img src="assets/examples/bouquet/mask.png" alt="bouquet mask" width="220"> | <img src="assets/examples/bouquet/reference.png" alt="bouquet reference" width="220"> | <img src="assets/examples/bouquet/result.png" alt="bouquet result" width="220"> |
